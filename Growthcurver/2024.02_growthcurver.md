Microbial growth analysis with the growthcurver R package
================
Andrew Tolonen
2024.02
...
analysis using the R package growthcurver. The growthcurver package is
described in this
...
enabling calculation of a generation time and carrying capacity.
